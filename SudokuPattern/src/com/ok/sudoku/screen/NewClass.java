 ...
 * @author Hasib
 */
import com.ok.sudoku.controller.StopWatch;
import com.ok.sudoku.controller.Sudoku;
import com.ok.sudoku.value.Game_Mode;
import com.ok.sudoku.value.Grid_Value;
...
public class NewClass extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mainMenu.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        mainMenu.setText("mainMenu");
        mainMenu.setMargin(new java.awt.Insets(0, 0, 0, 0));
        ...
        optionsLayout.setHorizontalGroup(
            ...
            .addGroup(optionsLayout.createSequentialGroup()
                ...
                .addComponent(mainMenu, javax.swing.GroupLayout.DEFAULT_SIZE, 75, Short.MAX_VALUE)
                .addGap(18, 18, 18)
        ...
        baseLayout.setVerticalGroup(
            ...
            .addGroup(baseLayout.createSequentialGroup()
                ...
                .addComponent(holder, javax.swing.GroupLayout.DEFAULT_SIZE, 516, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void intermediatorActionPerformed(java.awt.event.ActionEvent evt) {                                              
        gameMode = Game_Mode.GAME_MODE_MEDIUM;
        int[][] puzzle = sudoku.getNewPuzzle(grid, gameMode);
        createBoard(puzzle);
    }                                             

    private void expartActionPerformed(java.awt.event.ActionEvent evt) {                                       
        gameMode = Game_Mode.GAME_MODE_EXPART;
        int[][] puzzle = sudoku.getNewPuzzle(grid, gameMode);
        createBoard(puzzle);
    }                                      
    ...
    {                                       
        ...
        new MainMenuSelect().setVisible(true);
    ...
    private void viewInputs(JPanel block, JButton inputButtton, int numOfInput) {
       JPanel input = new Input(this, block, inputButtton, numOfInput);
